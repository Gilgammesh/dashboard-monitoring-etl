...
import { getMassiveHistoryView } from "@/actions/massive.actions";
...
const HistoryCalendar = forwardRef(
  ({ date, setDate, cloudFunction }: Props, ref) => {
    ...
    const refreshEvents = useCallback(async () => {
      ...
      const history = await getMassiveHistoryView(cloudFunction, view, dateStr);
    ...
    return (
      <div id="cargas-masivas" className="w-full">
        <Calendar
          culture="es"
          date={date}
          defaultDate={date}
...
HistoryCalendar.displayName = "HistoryCalendarMassive";
